...
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{} TODO: Total number of records}
        ...
        \PY{n}{greater\PYZus{}percent} \PY{o}{=} \PY{n+nb}{round}\PY{p}{(}\PY{n}{greater\PYZus{}percent}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}
...
with "\textgreater{}50K" to \texttt{1}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{} TODO: One\PYZhy{}hot encode the \PYZsq{}features\PYZus{}log\PYZus{}minmax\PYZus{}transform\PYZsq{} data using pandas.get\PYZus{}dummies()}
        
        \PY{c+c1}{\PYZsh{} Note that pd.get\PYZus{}dummies only encodes the string data types}
        \PY{c+c1}{\PYZsh{} OneHotEncoder in sklearn cannot process string values directly. If your nominal features are strings, then you need to first map them into integers.}
        \PY{c+c1}{\PYZsh{} So pd.get\PYZus{}dummies is good for categorical values}
        ...
        \PY{c+c1}{\PYZsh{} Another way of doing the same is as below}
        \PY{c+c1}{\PYZsh{}income = pd.get\PYZus{}dummies(income\PYZus{}raw)[\PYZsq{}\PYZgt{}50K\PYZsq{}]}
        
        \PY{c+c1}{\PYZsh{}print income.head(10)}
...
Run the code cell below to perform this split.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{} Import train\PYZus{}test\PYZus{}split}
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
         ...
         \PY{n}{TP} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{income}\PY{p}{)}
         \PY{n}{FP} \PY{o}{=} \PY{n}{income}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{n}{TP}
         ...
         \PY{n}{fscore} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{1}\PY{o}{+}\PY{l+m+mf}{0.5}\PY{o}{*}\PY{l+m+mf}{0.5}\PY{p}{)}\PY{o}{*}\PY{n+nb}{float}\PY{p}{(}\PY{n}{precision}\PY{p}{)}\PY{o}{*}\PY{n}{recall}\PY{o}{/}\PY{p}{(}\PY{p}{(}\PY{l+m+mf}{0.5}\PY{o}{*}\PY{l+m+mf}{0.5}\PY{o}{*}\PY{n}{precision}\PY{p}{)}\PY{o}{+}\PY{n}{recall}\PY{p}{)}
...
answer.
    ...
    \textbf{Answer: } Objective of the model is to predict the whether an
individual makes more than, or at most, \$50,000 annually. So model is
expected to classify the groups of people in two categories, one with
income \textless{}=50k and other group with \textgreater{}50k.

Following three supervised learning models are appropriate for this
...
implementation may take some time to run!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{} TODO: Import the three supervised learning models from sklearn}
         ...
         \PY{c+c1}{\PYZsh{}from sklearn.ensemble import AdaBoostClassifier}
         ...
         \PY{n}{clf\PYZus{}C} \PY{o}{=} \PY{n}{tree}\PY{o}{.}\PY{n}{DecisionTreeClassifier}\PY{p}{(}\PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
         \PY{c+c1}{\PYZsh{}clf\PYZus{}C = AdaBoostClassifier(random\PYZus{}state=0)}
         ...
         \PY{n}{samples\PYZus{}10} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{l+m+mf}{0.1}\PY{o}{*}\PY{n}{samples\PYZus{}100}\PY{p}{)}
         \PY{n}{samples\PYZus{}1} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{l+m+mf}{0.01}\PY{o}{*}\PY{n}{samples\PYZus{}100}\PY{p}{)}
         
         \PY{k}{print} \PY{n}{samples\PYZus{}100}
         \PY{k}{print} \PY{n}{samples\PYZus{}10}
         \PY{k}{print} \PY{n}{samples\PYZus{}1}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} TODO: Import \PYZsq{}GridSearchCV\PYZsq{}, \PYZsq{}make\PYZus{}scorer\PYZsq{}, and any other necessary libraries}
        ...
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{F\PYZhy{}score on testing data: \PYZob{}:.4f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{fbeta\PYZus{}score}\PY{p}{(}\PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{predictions}\PY{p}{,} \PY{n}{beta} \PY{o}{=} \PY{l+m+mf}{0.5}\PY{p}{)}\PY{p}{)}\PY{p}{)}
        ...
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Final F\PYZhy{}score on the testing data: \PYZob{}:.4f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{fbeta\PYZus{}score}\PY{p}{(}\PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{best\PYZus{}predictions}\PY{p}{,} \PY{n}{beta} \PY{o}{=} \PY{l+m+mf}{0.5}\PY{p}{)}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
